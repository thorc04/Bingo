...
function updateUI() {
    if (!lastdrawnNumber && numbers.length === settings.totalNumbers) {
        currentNumberDisplay.textContent = 'Press Draw';
        currentNumberDisplay.classList.add('press-draw-animation');
    } else {
        currentNumberDisplay.classList.remove('press-draw-animation');
